...
class RepeatCopy(snt.AbstractModule):
    ...
    def _build(self):
        ...
        # the trailing dimension of the tensor
        ...
        # Definition of the index for the channels
        start_end_flag_idx = full_obs_size - 2 # second last
        num_repeats_channel_idx = full_obs_size - 1 # last

        # Samples each batch index's sequence length and the number of repeats.
        # draw a number of samples equals to the number of series in the batch
        ...
        # the first dimensionality of the tensor
        ...
        for batch_index in range(batch_size):
            # previously randomly computed (this is the number of sequences of bits)
            sub_seq_len = sub_seq_length_batch[batch_index]
            # previously randomly computed
            num_reps = num_repeats_batch[batch_index]

            # The observation pattern is a sequence of random binary vectors.
            # create the matrix which is a number of bits and a sequence length
            ...
            # craate a vector of the observation
